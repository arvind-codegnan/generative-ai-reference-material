...
- [8. ChatModel and ChatClient](#9-chatmodel-and-chatclient)
- [9. Create the First AI Service](#10-create-the-first-ai-service)
- [10. Expose a REST Endpoint](#11-expose-a-rest-endpoint)
- [11. System Messages and Prompt Templates](#12-system-messages-and-prompt-templates)
- [12. Model Options](#13-model-options)
- [13. ChatResponse and Metadata](#14-chatresponse-and-metadata)
- [14. Structured Output into Java Records](#15-structured-output-into-java-records)
- [15. Streaming Responses](#16-streaming-responses)
- [16. Advisors](#17-advisors)
- [17. Conversation Memory](#18-conversation-memory)
- [18. Persistent Chat Memory with JDBC](#19-persistent-chat-memory-with-jdbc)
- [19. Tool Calling with Spring Methods](#20-tool-calling-with-spring-methods)
- [20. Embeddings with EmbeddingModel](#21-embeddings-with-embeddingmodel)
- [21. Documents and VectorStore](#22-documents-and-vectorstore)
- [22. ETL for AI Documents](#23-etl-for-ai-documents)
- [23. Retrieval-Augmented Generation](#24-retrieval-augmented-generation)
- [24. PGvector for a Production-Style RAG Application](#25-pgvector-for-a-production-style-rag-application)
- [25. Exception Handling and Resilience](#26-exception-handling-and-resilience)
- [26. Validation and API Design](#27-validation-and-api-design)
- [27. Observability and Logging](#28-observability-and-logging)
- [28. Testing and Evaluation](#29-testing-and-evaluation)
- [29. Security and Responsible AI](#30-security-and-responsible-ai)
- [30. Cost and Performance](#31-cost-and-performance)
- [31. Model Context Protocol](#32-model-context-protocol)
- [32. Suggested Package Structure](#33-suggested-package-structure)
- [33. Mini-Project: Java Learning Assistant](#34-mini-project-java-learning-assistant)
- [34. Common Errors](#35-common-errors)
- [35. Frequently Asked Interview Questions](#36-frequently-asked-interview-questions)
