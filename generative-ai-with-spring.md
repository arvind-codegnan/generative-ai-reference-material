...
- [3. Version Baseline and Requirements](#3-version-baseline-and-requirements)
- [4. Core Java Integration vs Spring AI](#4-core-java-integration-vs-spring-ai)
- [5. Spring AI Application Architecture](#5-spring-ai-application-architecture)
- [6. Create the Maven Project](#6-create-the-maven-project)
- [7. Configure the Model Provider](#7-configure-the-model-provider)
- [8. Auto-Configuration and Dependency Injection](#8-auto-configuration-and-dependency-injection)
- [9. ChatModel and ChatClient](#9-chatmodel-and-chatclient)
- [10. Create the First AI Service](#10-create-the-first-ai-service)
- [11. Expose a REST Endpoint](#11-expose-a-rest-endpoint)
- [12. System Messages and Prompt Templates](#12-system-messages-and-prompt-templates)
- [13. Model Options](#13-model-options)
- [14. ChatResponse and Metadata](#14-chatresponse-and-metadata)
- [15. Structured Output into Java Records](#15-structured-output-into-java-records)
- [16. Streaming Responses](#16-streaming-responses)
- [17. Advisors](#17-advisors)
- [18. Conversation Memory](#18-conversation-memory)
- [19. Persistent Chat Memory with JDBC](#19-persistent-chat-memory-with-jdbc)
- [20. Tool Calling with Spring Methods](#20-tool-calling-with-spring-methods)
- [21. Embeddings with EmbeddingModel](#21-embeddings-with-embeddingmodel)
- [22. Documents and VectorStore](#22-documents-and-vectorstore)
- [23. ETL for AI Documents](#23-etl-for-ai-documents)
- [24. Retrieval-Augmented Generation](#24-retrieval-augmented-generation)
- [25. PGvector for a Production-Style RAG Application](#25-pgvector-for-a-production-style-rag-application)
- [26. Exception Handling and Resilience](#26-exception-handling-and-resilience)
- [27. Validation and API Design](#27-validation-and-api-design)
- [28. Observability and Logging](#28-observability-and-logging)
- [29. Testing and Evaluation](#29-testing-and-evaluation)
- [30. Security and Responsible AI](#30-security-and-responsible-ai)
- [31. Cost and Performance](#31-cost-and-performance)
- [32. Model Context Protocol](#32-model-context-protocol)
- [33. Suggested Package Structure](#33-suggested-package-structure)
- [34. Mini-Project: Java Learning Assistant](#34-mini-project-java-learning-assistant)
- [35. Common Errors](#35-common-errors)
